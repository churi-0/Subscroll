...
// Stored client ID (user-configurable, no hardcoded default)
function getClientId(){ try{ return localStorage.getItem(CID_KEY)||''; }catch(e){ return ''; } }
function setClientId(v){ try{ localStorage.setItem(CID_KEY,v); }catch(e){} }
